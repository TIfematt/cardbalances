    ...
    <div className='flex items-center justify-center bg-primary w-screen h-screen bg-opacity-50'>
      <div className='bg-white rounded-lg w-96 h-96'>
        ...
        <div className='flex gap-4 mt-20 mx-4'>
          <Link className='w-full h-full bg-gray-600 text-white p-4 flex items-center justify-center' href='/'>Cancel</Link>
          <Link className='w-full h-full bg-blue-600 text-white p-4 flex items-center justify-center' href='/#verify' >Try Again</Link>
        </div>
      </div>
    </div>
  )
